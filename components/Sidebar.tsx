...
export default function Sidebar({ items, filter, onFilterChange }: SidebarProps) {
  ...
  return (
    <>
      <aside className="fixed left-0 top-0 h-full w-60 bg-vault-surface border-r border-vault-border flex flex-col z-10">
        {/* Logo */}
                    ...
                    >
                      ...
                      <span
                        className={`text-xs flex-shrink-0 ${
                          isActive ? "text-purple-400" : "text-vault-muted"
                        }`}
                      >
                        {count}
                      </span>
